...
namespace pyro {
    jaws::jaws(okapi::Motor jawsMotor, pros::ADIDigitalIn limit, pros::ADIDigitalIn jawsTrigger, double target_pos)
            : jawsMotor(std::move(jawsMotor)),
